...
const seedDB = async () => {
  ...
  for (let i = 0; i < 200; i++) {
    ...
    const camp = new Campground({
      ...
      images: [
        {
          url: "https://images.unsplash.com/photo-1730812393789-a7d15960029d?q=80&w=1887&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
